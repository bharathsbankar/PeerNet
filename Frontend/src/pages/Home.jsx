...
import { Calendar, MapPin, ExternalLink, Clock, X, Info } from 'lucide-react';
import Header from '../components/Header';
import { dummyFeeds } from '../data/dummyData';

const Home = () => {
    const [feeds] = useState(dummyFeeds);
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    <div className="relative w-full max-w-5xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-slide-up flex flex-col md:flex-row max-h-[90vh]">
                        ...
                        <div className="w-full md:w-1/2 p-8 flex flex-col overflow-y-auto bg-white">
                            <div className="flex items-center space-x-2 text-primary-600 text-sm font-semibold tracking-wide uppercase mb-3">
                                <Info size={16} />
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center space-x-3">
                                        <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center text-primary-700 font-bold">
                                            {selectedFeed.postedBy.name.charAt(0)}
                                        </div>
                                        <div>
                                            <p className="text-sm font-medium text-gray-900">Posted by</p>
                                            <p className="text-xs text-gray-500">{selectedFeed.postedBy.name}</p>
                                        </div>
                                    </div>
